...
from agentq_api.db import models  # noqa: F401 - registers all tables on Base.metadata
...
def include_name(name, type_, parent_names) -> bool:
    """LangGraph's AsyncPostgresSaver.setup() owns the checkpoint_* tables - Alembic must never
